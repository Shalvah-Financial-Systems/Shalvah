...
export default function AdminDashboardContent({ stats }: { stats: any }) {
  return (
    <div className="h-full overflow-y-auto">
      <div className="p-6">
        ...
        >
          ...
          <StatsCard
            title="Empresas"
            value={stats.usersByType?.find((t: any) => t.type === 'ENTERPRISE')?.count || 0}
            icon={Building2}
        ...
        >
          ...
          <div className="bg-white p-6 rounded-lg border">
            ...
            <div className="space-y-3">
              {stats.usersByType?.map((type: any) => (
